...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , clk{vlSymsp->TOP.clk}
    , rst{vlSymsp->TOP.rst}
    , input_buffer_load_en{vlSymsp->TOP.input_buffer_load_en}
    , input_buffer_out_en{vlSymsp->TOP.input_buffer_out_en}
    , weight_buffer_load_en{vlSymsp->TOP.weight_buffer_load_en}
    , weight_buffer_out_en{vlSymsp->TOP.weight_buffer_out_en}
    , output_buffer_load_en{vlSymsp->TOP.output_buffer_load_en}
    , output_buffer_out_en{vlSymsp->TOP.output_buffer_out_en}
    , write_weight_en{vlSymsp->TOP.write_weight_en}
    , out_res{vlSymsp->TOP.out_res}
    , in_act{vlSymsp->TOP.in_act}
    , in_weight{vlSymsp->TOP.in_weight}
    , rootp{&(vlSymsp->TOP)}
{
